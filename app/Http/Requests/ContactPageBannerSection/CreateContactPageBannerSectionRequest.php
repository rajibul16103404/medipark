...
namespace App\Http\Requests\ContactPageBannerSection;

use App\Status;
use Illuminate\Foundation\Http\FormRequest;
use Illuminate\Validation\Rule;

class CreateContactPageBannerSectionRequest extends FormRequest
{
    /**
    ...
    {
        return [
            'background_image' => $this->imageOrUrlRule(),
