...
namespace App\Http\Requests\AboutUsPageAfterOurVisionSection;

use App\Status;
use Illuminate\Foundation\Http\FormRequest;
use Illuminate\Validation\Rule;

class UpdateAboutUsPageAfterOurVisionSectionRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'image_4' => ['sometimes', $imageValidation],
