...
class CreateInvestorInstallmentRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'status' => ['nullable', Rule::enum(InstallmentStatus::class)],
    ...
    {
        return [
            'investor_id.required' => 'The investor is required.',
