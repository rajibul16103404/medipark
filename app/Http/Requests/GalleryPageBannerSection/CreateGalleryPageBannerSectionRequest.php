...
namespace App\Http\Requests\GalleryPageBannerSection;

use App\Status;
use Illuminate\Foundation\Http\FormRequest;
use Illuminate\Validation\Rule;

class CreateGalleryPageBannerSectionRequest extends FormRequest
{
    /**
                ...
                function ($attribute, $value, $fail) {
                    ...
                    if ($this->hasFile($attribute)) {
                        ...
                        if (! $file->isValid()) {
                            ...
                            $errorMessages = [
                                UPLOAD_ERR_INI_SIZE => 'The file exceeds the upload_max_filesize directive in php.ini (currently '.ini_get('upload_max_filesize').'). Please increase upload_max_filesize and post_max_size in php.ini to at least 50MB for videos.',
