...
namespace App\Http\Requests\AboutUsPageOurMissionSection;

use App\Status;
use Illuminate\Foundation\Http\FormRequest;
use Illuminate\Validation\Rule;

class UpdateAboutUsPageOurMissionSectionRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'image' => ['sometimes', $imageValidation],
